				...
				rightElement={
					<button
						...
						className={css({
							position: "absolute",
							zIndex: 10,
							top: { base: "0.625rem", md: "1rem" },
							right: { base: "0.625rem", md: "1rem" },
							display: "inline-flex",
							alignItems: "center",
							...
							bg: "var(--surface)",
							px: { base: "0.625rem", md: "0.875rem" },
							py: { base: "0.375rem", md: "0.5rem" },
							fontSize: "0.875rem",
							fontWeight: "700",
